...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="PSRP_inference")
    choices_list = list(MODELS.keys())
    parser.add_argument("--model_select", type=str, default="model_name", choices=choices_list, help="Model to use")
    ...
    QUESTIONPATH = "/Code/Data/Human-Data-Question-list.json"    
